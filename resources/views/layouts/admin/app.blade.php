...
<body
    x-data="{ adminMenuOpen: false, sidebarCollapsed: false }"
    class="bg-[#f8f3f1] font-sans text-[#2d2928]"
>
    <div class="flex min-h-screen">
        ...
        <div
            ...
            class="fixed inset-0 z-40 bg-[#2d2928]/45 lg:hidden"
            x-cloak
        ></div>
        ...
        <main class="min-w-0 flex-1 p-5 sm:p-8 lg:p-10">
            <div class="mb-6 flex items-center justify-between lg:hidden">
                ...
                <span class="font-['Cormorant_Garamond'] text-xl font-semibold tracking-[0.06em]">
                    MALU STORE
                </span>
            </div>
