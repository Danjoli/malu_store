<footer class="mt-20 border-t border-[#eee6e4] bg-[#fffaf9]">
    ...
    <div class="store-container grid gap-8 py-[clamp(2.5rem,4vw,5rem)] text-[clamp(0.75rem,0.82vw,1rem)] text-stone-600 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            <h3 class="store-title mb-3 text-[clamp(1.6rem,2vw,3rem)] font-semibold tracking-[-.06em] text-stone-900">MALU STORE</h3>
            <p class="leading-6">Moda para acompanhar os seus melhores momentos.</p>
        </div>

        <div>
            <h3 class="mb-3 text-[clamp(0.62rem,0.65vw,0.82rem)] font-bold uppercase tracking-wider text-stone-900">Institucional</h3>
        ...
        <div>
            <h3 class="mb-3 text-[clamp(0.62rem,0.65vw,0.82rem)] font-bold uppercase tracking-wider text-stone-900">Atendimento</h3>
        ...
        <div><h3 class="mb-3 text-[clamp(0.62rem,0.65vw,0.82rem)] font-bold uppercase tracking-wider text-stone-900">Compra segura</h3><p class="leading-6">Pagamento protegido e envio para todo o Brasil.</p></div>
