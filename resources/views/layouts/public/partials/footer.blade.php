<footer class="mt-20 border-t border-[#eee6e4] bg-[#fffaf9]">
    ...
    <div
        class="store-container grid gap-8 py-[clamp(2.5rem,4vw,5rem)] text-[clamp(0.75rem,0.82vw,1rem)] text-stone-600 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            ...
            <p>
                ...
                <a href="https://wa.me/5511931494708?text=Olá,%20gostaria%20de%20mais%20informações"
                    class="text-[#bd5564] hover:underline" target="_blank">
                    (11) 93149-4708
                </a>
            </p>
        ...
        <div>
            <h3 class="mb-3 text-[clamp(0.62rem,0.65vw,0.82rem)] font-bold uppercase tracking-wider text-stone-900">
                Compra segura</h3>
            <p class="leading-6">Pagamento protegido e envio para todo o Brasil.</p>
        </div>
