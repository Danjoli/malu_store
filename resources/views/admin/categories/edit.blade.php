...
<div class="mx-auto max-w-2xl">
    <div class="w-full">
        ...
        <p class="text-xs font-bold uppercase tracking-[0.18em] text-[#c96f82]">Catálogo</p><h1 class="mt-2 font-['Cormorant_Garamond'] text-4xl font-semibold mb-6">Editar categoria</h1>
