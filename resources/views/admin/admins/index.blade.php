                ...
                <tbody class="divide-y divide-[#f0e5e1]">
                    @forelse ($admins as $admin)
                        ...
                        <tr class="transition hover:bg-[#fdf8f6]">
                            ...
                            <td class="p-4">
                                <span class="rounded-full px-2.5 py-1 text-xs font-bold {{ $admin->is_active ? 'bg-[#eaf6ef] text-[#27754a]' : 'bg-[#fdf0f3] text-[#b44259]' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="p-12 text-center text-[#746b68]">
