...
@section('content')
    <div class="w-full max-w-lg rounded-2xl border border-[#eaded9] bg-white p-6 text-center shadow-[0_12px_34px_rgba(76,50,47,0.08)] sm:p-8">
        ...
        <div class="my-6 rounded-xl bg-[#fff6df] px-4 py-3 text-sm text-[#986d16]">
            Este pagamento expira em
            <strong id="countdown">--:--</strong>
        </div>

        <div class="rounded-2xl bg-[#fdf8f6] p-5">
            <img
        ...
        <div class="mt-6 text-left">
            <label for="pixCode" class="mb-2 block text-sm font-semibold text-[#443d3b]">
                Pix Copia e Cola
            </label>
            ...
            <textarea
                id="pixCode"
                readonly
                class="h-24 w-full rounded-xl border border-[#ded4d0] p-3 text-xs text-[#625956]"
            >{{ $qr_code }}</textarea>
