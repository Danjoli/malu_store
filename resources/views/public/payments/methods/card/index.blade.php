...
@section('content')
    <div
        class="w-full max-w-lg rounded-2xl border border-[#eaded9] bg-white p-6 shadow-[0_12px_34px_rgba(76,50,47,0.08)] sm:p-8">
        ...
        <div id="cardError"
            class="hidden mb-4 mt-6 rounded-xl border border-[#f1c8d0] bg-[#fdf0f3] p-4 text-sm text-[#b44259]"></div>
