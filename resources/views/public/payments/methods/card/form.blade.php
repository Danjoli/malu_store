<form id="cardPaymentForm" method="POST" action="{{ route('payment.card.process', $order->id) }}">

    @csrf

    {{-- Número do cartão --}}
    <div class="mb-4">
        <label for="card_number" class="mb-2 block text-sm font-semibold text-[#443d3b]">
            Número do cartão
        </label>
    ...
    {{-- Nome do titular --}}
    <div class="mb-4">
        <label for="holder_name" class="mb-2 block text-sm font-semibold text-[#443d3b]">
            Nome no cartão
        </label>

        <input type="text" id="holder_name" name="holder_name" placeholder="Nome como aparece no cartão"
            class="w-full rounded-xl border border-[#ded4d0] px-4 py-3 text-sm outline-none focus:border-[#cf7184] focus:ring-4 focus:ring-[#f7dce2]"
            required>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
            <label for="expiration_month" class="mb-2 block text-sm font-semibold text-[#443d3b]">
                Mês
            </label>
        ...
        <div>
            <label for="expiration_year" class="mb-2 block text-sm font-semibold text-[#443d3b]">
                Ano
            </label>
    ...
    <div class="mb-4">
        ...
        <label for="ccv" class="mb-2 block text-sm font-semibold text-[#443d3b]">
            CVV
        </label>

        <input type="text" id="ccv" name="ccv" maxlength="4" placeholder="123"
            class="w-full rounded-xl border border-[#ded4d0] px-4 py-3 text-sm outline-none focus:border-[#cf7184] focus:ring-4 focus:ring-[#f7dce2]"
            required>
    ...
    {{-- Botão --}}
    <button type="submit" id="cardSubmitButton"
