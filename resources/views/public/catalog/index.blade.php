        ...
        <div class="grid gap-8 lg:grid-cols-[190px_1fr]">
            <aside class="hidden lg:block">
                ...
                <form method="GET" class="mt-8 border-t border-[#eee6e4] pt-6 text-xs">
                    ...
                    <h2 class="mb-4 font-bold text-stone-800">
                        Filtros
                    </h2>

                    <p class="mb-3 font-semibold text-stone-700">
                        Cor
                    </p>
                    ...
                    <p class="mb-2 font-semibold text-stone-700">
                        Tamanho
                    </p>
                    ...
                    <p class="mb-2 mt-6 font-semibold text-stone-700">
                        Faixa de preço
                    </p>

                    <div class="relative mb-4 h-4">
                        <div class="absolute top-1/2 h-0.5 w-full -translate-y-1/2 bg-stone-800"></div>

                        <span class="absolute left-0 top-1/2 h-3 w-3 -translate-y-1/2 rounded-full border-2 border-stone-800 bg-white"></span>
                        <span class="absolute right-0 top-1/2 h-3 w-3 -translate-y-1/2 rounded-full border-2 border-stone-800 bg-white"></span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <input
                            ...
                            placeholder="R$ 0"
                            class="store-input px-2 py-2 text-xs"
                        >
                    ...
                    <button class="store-button store-button-primary mt-4 w-full">
                        Filtrar
                    </button>
                </form>
            </aside>
            ...
            <section>
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <form method="GET" class="flex items-center gap-2">
                        <span class="hidden text-[10px] text-stone-500 sm:inline">
                            Ordenar por:
                        </span>
                        ...
                        <select
                            ...
                            class="store-input w-auto py-2 text-xs"
                        >
                            <option value="recent" @selected(request('sort', 'recent') === 'recent')>
                                Mais recentes
                            </option>
                ...
                @if ($products->hasPages())
                    <nav
                        class="mt-10 flex items-center justify-center gap-1.5 text-xs"
                    ...
                    >
                        ...
                        @else
                            <a
                                ...
                                class="px-2 text-stone-700 hover:text-[#bd5564]"
                            >
                                ‹
                            </a>
                        @endif
                        ...
                        @else
                            <span class="px-2 text-stone-300">
                                ›
                            </span>
                        @endif
                    </nav>
