...
@section('content')
    ...
    <div class="store-container max-w-4xl py-10 md:py-14">
        ...
        <div
            class="mb-6 space-y-4 rounded-md border border-[#eee6e4] bg-white p-5 shadow-[0_10px_30px_rgba(63,38,35,.05)] md:p-6">
                    ...
                    <div class="flex items-center space-x-4 border-b border-[#eee6e4] py-4">
                        ...
                        @if ($item->image_snapshot)
                            <img src="{{ asset('storage/products/' . $item->image_snapshot) }}"
                                alt="{{ $item->name_snapshot }}" class="h-20 w-16 rounded-sm object-cover">
                        @else
                            <div
