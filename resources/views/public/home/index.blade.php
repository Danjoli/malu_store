...
@section('content')
    <section class="border-b border-[#eee6e4] bg-[#f8eee9]">
        <div class="relative min-h-[440px] overflow-hidden sm:min-h-[410px] md:min-h-[450px]">
            <img src="{{ asset('storage/products/hero-malu-store.png') }}" alt="Nova coleção Malu Store" class="absolute inset-0 h-full w-full object-cover object-[64%_center] sm:object-[65%_center]">
            ...
            <div class="store-container home-container relative z-10 flex min-h-[440px] items-center py-12 sm:min-h-[410px] md:min-h-[450px]">
                ...
                <h1 class="store-title text-[2.25rem] leading-[1.02] text-stone-900 sm:text-4xl md:text-5xl">Elegância para todos os momentos</h1>
    ...
    <div id="produtos" class="store-container home-container py-14">
        <div class="mb-8 flex items-center gap-2 sm:gap-4">
            <span class="h-px flex-1 bg-[#eadfdd]"></span><div class="text-center"><h2 class="store-title text-2xl sm:text-3xl">Novidades</h2></div><span class="h-px flex-1 bg-[#eadfdd]"></span><a href="{{ route('home') }}" class="shrink-0 text-[11px] font-semibold text-stone-700 transition hover:text-[#bd5564] sm:text-xs">Ver todas</a>
        </div>
